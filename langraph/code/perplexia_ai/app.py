...
def create_demo(
    week: int = 1, mode_str: str = "part1", use_solution: bool = False
) -> gr.ChatInterface:
    ...
    if week == 1:
        if use_solution:
            from perplexia_ai.solutions.week1.factory import (
                Week1Mode,
                create_chat_implementation,
            )
        else:
        ...
        if use_solution:
            from perplexia_ai.solutions.week2.factory import (
                Week2Mode,
                create_chat_implementation,
            )
        else:
